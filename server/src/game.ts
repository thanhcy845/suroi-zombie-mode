...
import { type ZombiePlayer } from "./zombies/zombiePlayer";
...
export class Game implements GameData {
    ...
    */
    ...
    /**
     * Zombie management system
     */
    readonly zombieManager: ZombieManager;
    ...
    kill(): void {
        ...
        if (this._zombieSpawnTimeout) {
            this._zombieSpawnTimeout.kill();
        }
        this.zombieManager.cleanup();
    ...
    activatePlayer(player: Player, packet: JoinData): void {
        ...
        if (
            ...
            this.startTimeout = this.addTimeout(() => {
                ...
                // Schedule zombie spawning check for solo mode
                if (this.teamMode === TeamMode.Solo) {
                    this.scheduleZombieSpawning();
                }
            }, 3000);
        }
     ...
     */
    get zombieModeEnabled(): boolean {
        return this._zombieModeEnabled;
    }
